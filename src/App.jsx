            ...
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="md:col-span-2 space-y-6">
                ...
                <Card className="rounded-2xl bg-white/95">
                  ...
                  <CardContent className="space-y-4">
                    <p className="text-sm leading-6 text-muted-foreground">
                      Environmental microbiologist, lead for the MEME Lab and Director of the PAMS Hub. Award-winning, data-driven scientist, former would-be science journalist and market gardener. Team-sport enthusiast shaped by immigrant roots and passion for nature. Read more about me in the Propsective Students link.
                    </p>
                    <div className="flex flex-col gap-2 sm:flex-row">
                    </div>
                  </CardContent>
